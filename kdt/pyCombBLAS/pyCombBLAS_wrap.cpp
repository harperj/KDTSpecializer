...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'new_pyObjDenseParVec'.\n"
    "  Possible C/C++ prototypes are:\n"
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'pyObjDenseParVec___getitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'pyObjDenseParVec___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'new_ObjUnaryFunction'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_gmultiplies(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SwigValueWrapper< op::BinaryFunction > result;
  
  if (!PyArg_ParseTuple(args,(char *)":gmultiplies")) SWIG_fail;
  {
    try {
      result = op::gmultiplies();
    } catch(string& stringReason) {
      const char* sData = (char*)stringReason.c_str();
      SWIG_exception(SWIG_RuntimeError,sData);
      SWIG_exception(SWIG_IndexError,sData);
...
SWIGINTERN PyObject *_wrap_EWiseApply__SWIG_6(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  ecode4 = SWIG_AsVal_double(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "EWiseApply" "', argument " "4"" of type '" "double""'");
  } 
  arg4 = static_cast< double >(val4);
  {
    try {
      result = EWiseApply((pySpParVec const &)*arg1,(pyDenseParVec const &)*arg2,arg3,arg4);
    } catch(string& stringReason) {
      const char* sData = (char*)stringReason.c_str();
      SWIG_exception(SWIG_RuntimeError,sData);
      SWIG_exception(SWIG_IndexError,sData);
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'EWiseApply'.\n"
    ...
    "    EWiseApply(pySpParVec const &,pyDenseParVec const &,op::BinaryFunction *,double)\n");
  return NULL;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gmultiplies", _wrap_gmultiplies, METH_VARARGS, NULL},
